...
my_df2 = LCTMC:::fmt_rowwise_3x3trans(data = my_df)
...
my_theta = c("alpha0.1" = 1.0, "alpha1.1" = 1.0, "alpha2.1" = 1.0,
             ...
             "beta0.23_1" = 0.8, "beta1.23_1" = 0.8, "beta2.23_1" = 0.8,
             "beta0.12_2" = 1.8, "beta1.12_2" = 1.8, "beta2.12_2" = 1.8,
             "beta0.21_2" = 0.3, "beta1.21_2" = 0.3, "beta2.21_2" = 0.3,
             "beta0.23_2" = 0.6, "beta1.23_2" = 0.6, "beta2.23_2" = 0.6)

# use bik_all_3x3() ~ cases of 2 latent classes
LCTMC:::bik_all_3x3(
  theta = my_theta,
  ...
  P.rs = FALSE,
  K = 2L,
  theta.names = gen_theta_names(K = 2L, type = "3x3", purpose = "bik")
)

# - # - # - # - # - # - # - # - # -

# create theta vector ~ cases of 3 latent classes
my_theta = c("alpha0.1" = 1.0, "alpha1.1" = 1.0, "alpha2.1" = 1.0,
             ...
             "beta0.23_3" = 0.1, "beta1.23_3" = 0.1, "beta2.23_3" = 0.1)

# use bik_all_3x3() ~ cases of 3 latent classes
LCTMC:::bik_all_3x3(
  theta = my_theta,
  data = my_df2, dt = my_df2$dt,
  Xmat = xmat,
  ...
  P.rs = FALSE,
  K = 3L,
  theta.names = gen_theta_names(K = 3L, type = "3x3", purpose = "bik")
)

# - # - # - # - # - # - # - # - # -

# create theta vector ~ cases of 4 latent classes
my_theta = c("alpha0.1" = 1.0, "alpha1.1" = 1.0, "alpha2.1" = 1.0,
             "alpha0.2" = 0.5, "alpha1.2" = 0.2, "alpha2.2" = 0.2,
             "alpha0.3" = -1.0, "alpha1.3" = -1.0, "alpha2.3" = -1.0,
             "beta0.12_1" = 1.1, "beta1.12_1" = 1.1, "beta2.12_1" = 1.1,
             "beta0.21_1" = 1.5, "beta1.21_1" = 1.5, "beta2.21_1" = 1.5,
             "beta0.23_1" = 0.8, "beta1.23_1" = 0.8, "beta2.23_1" = 0.8,
             "beta0.12_2" = 1.8, "beta1.12_2" = 1.8, "beta2.12_2" = 1.8,
             ...
             "beta0.21_3" = 0.4, "beta1.21_3" = 0.4, "beta2.21_3" = 0.4,
             "beta0.23_3" = 0.1, "beta1.23_3" = 0.1, "beta2.23_3" = 0.1,
             "beta0.12_4" = 0.4, "beta1.12_4" = 0.4, "beta2.12_4" = 0.4,
             "beta0.21_4" = 0.5, "beta1.21_4" = 0.5, "beta2.21_4" = 0.5,
             "beta0.23_4" = 0.6, "beta1.23_4" = 0.6, "beta2.23_4" = 0.6)

# use bik_all_3x3() ~ cases of 4 latent classes
LCTMC:::bik_all_3x3(
  theta = my_theta,
  data = my_df2, dt = my_df2$dt,
  Xmat = xmat,
  ...
  P.rs = FALSE,
  K = 4L,
  theta.names = gen_theta_names(K = 4L, type = "3x3", purpose = "bik")
)
