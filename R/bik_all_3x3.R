...
#'
#' @description For a 3x3 CTMC model, computes \eqn{b_{ik}} for \eqn{k \geq 2}
#'
...
#' i.e., `trans.1_1`, `trans.1_2`, `trans.1_3`, `trans.2_1`, `trans.2_2`, `trans.2_3`
...
#' Furthermore, this functions combines `get_P_3x3()` and `Li_3x3()` to obtain the quantities \eqn{P_{rs(k)}} or \eqn{b_{ik}}. \cr\cr
...
bik_all_3x3 = function(theta = c(),
  ...
  for (k in 1:K) {
    ...
    # P.rs
    P.rs_k = get_P_3x3(q12 = q.12_k, q21 = q.21_k, q23 = q.23_k, dt = dt)
    P.rs.list[[k]] = P.rs_k
  }
