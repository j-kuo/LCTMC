...
#'
#' @description For a 2x2 CTMC model, computes \eqn{b_{ik}} for \eqn{k \geq 2}
#'
#' @param theta a named vector of numeric values for the model parameters
#' @param data a data frame object containing the binary transition indicator variables \cr
#' i.e., `trans.1_1`, `trans.1_2`, `trans.2_1`, `trans.2_2`
...
#' Furthermore, this functions combines `get_P_2x2()` and `Li_2x2()` to obtain the quantities \eqn{P_{rs(k)}} or \eqn{b_{ik}}. \cr\cr
...
#'
#' @seealso [get_P_2x2()], [Li_2x2()], [bik_all_3x3()]
#'
#' @example inst/examples/ex_bik_all_2x2.R
...
bik_all_2x2 = function(theta = c(),
  ...
  for (k in 1:K) {
    ...
    # P.rs
    P.rs_k = get_P_2x2(q12 = q.12_k, q21 = q.21_k, dt = dt)
    P.rs.list[[k]] = P.rs_k
  }
