...
#'
#' @param P A data frame object containing the transition probabilities/densities,
#' named `P11, P12, P13, P21, P22, P23, P13_exact, P23_exact`. \cr This data frame object can be obtained from `get_P_3x3()`.
#' @param data A data frame object containing the binary transition indicator variables named as `trans.1_1, trans.1_2, trans.1_3, trans.2_1, trans.2_2, trans.2_3`. \cr
#' This data frame object can be obtained from `fmt_rowwise_3x3trans()`
#'
