#' @title Prediction function for the latent class CTMC model (3x3)
#'
#' @description Performs two types of prediction using the 3x3 latent CTMC model: \cr
#' **(1)** predicts the latent cluster classification. \cr
#' **(2)** predicts the disease status at a user specified time
#'
#' @param object an object of class "lctmc_3x3". Obtained by fitting the latent class CTMC model using `lctmc_3x3()`
...
#' @exportS3Method
#'
#' @example inst/examples/ex_predict_3x3.R
...
predict.lctmc_3x3 = function(object, ...) {
  ...
  my_df1 = fmt_rowwise_3x3trans(data = df_past)
