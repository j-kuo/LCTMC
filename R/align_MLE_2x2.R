...
#' @export
#'
#' @example inst/examples/ex_align_MLE_2x2.R
...
align_MLE_2x2 = function(true, mle = c(), K = 3L) {
  ...
  if (!missing("true")) {
    ...
    warning("`true` is missing, supplying with NA to indicate missing")
