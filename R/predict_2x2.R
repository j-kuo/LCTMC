#' @title Prediction function for the latent class CTMC model (2x2)
#'
#' @description Performs two types of prediction using the 2x2 latent CTMC model: \cr
#' **(1)** predicts the latent cluster classification. \cr
#' **(2)** predicts the disease status at a user specified time
#'
#' @param object an object of class "lctmc_2x2". Obtained by fitting the latent class CTMC model using `lctmc_2x2()`
...
#' @exportS3Method
#'
#' @example inst/examples/ex_predict_2x2.R
...
predict.lctmc_2x2 = function(object, ...) {
  ...
  my_df1 = fmt_rowwise_2x2trans(data = df_past)
